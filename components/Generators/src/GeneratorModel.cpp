...
struct GeneratorModel::PrivateData final {
  ...
  QModelIndex ToIndex(const GeneratorModel *model,
...
// Convert a `node_key` into a `QModelIndex`.
QModelIndex GeneratorModel::PrivateData::ToIndex(
    const GeneratorModel *model, const NodeKey *node_key) const {
...
gap::generator<NodeKey *> GeneratorModel::PrivateData::Children(
    Node *node) & {
...
void GeneratorModel::Expand(const QModelIndex &index, unsigned depth) {
...
void GeneratorModel::PrivateData::ImportData(
