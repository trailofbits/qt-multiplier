...
ReferenceExplorerTreeView::ReferenceExplorerTreeView(QWidget *parent)
    : QTreeView(parent) {}

ReferenceExplorerTreeView::~ReferenceExplorerTreeView() {}

void ReferenceExplorerTreeView::drawRow(QPainter *painter,
