...
class ClassHierarchyPlugin Q_DECL_FINAL : public IReferenceExplorerPlugin {
  Q_OBJECT
 ...
 public:
  virtual ~ClassHierarchyPlugin(void);

  ClassHierarchyPlugin(ConfigManager &config_manager, QObject *parent = nullptr);
